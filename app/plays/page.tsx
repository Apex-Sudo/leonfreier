    ...
    <main className="min-h-screen pt-14">
      <section className="px-6 pt-16 pb-8 md:pt-24 md:pb-12">
        <div className="max-w-3xl mx-auto">
          <h1 className="text-2xl md:text-3xl font-semibold tracking-tight mb-3">Plays</h1>
      ...
      <section className="px-6 pb-16 md:pb-24">
        <div className="max-w-3xl mx-auto space-y-5">
          ...
          <a href="/plays/gpu-compute" className="glass-card p-8 block transition-all duration-200 hover:border-accent/20">
